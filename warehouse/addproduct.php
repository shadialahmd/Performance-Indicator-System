<?php
	...
	mysqli_query($con,"insert into product (prod_name,categoryid,p_quantity,img_src) values ('$prodname','$prodcat','$pqty','$location')");
	$pid=mysqli_insert_id($con);
	
	mysqli_query($con,"insert into product_backup (prod_name,categoryid,p_quantity,img_src) values ('$prodname','$prodcat','$pqty','$location')");
