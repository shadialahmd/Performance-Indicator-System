		...
		<div id="page-wrapper">
            <div class="container-fluid">
				...
				<div style="height:20px;"></div>
					<?php
						$e=mysqli_query($con,"select * from employee left join emp_position on emp_position.positionid=employee.positionid left join `user` on user.userid=employee.userid where employee.userid='".$_SESSION['id']."'");
				...
				<div class="row">
					...
					<div class="col-lg-9">
						<div class="form-group input-group">
							...
							<p style="width:480px;" class="form-control"><?php echo ucwords($er['lastname']); ?>, <?php echo ucwords($er['firstname']); ?> <?php echo ucwords($er['middle_i']); ?></p>
						</div>
						<div class="form-group input-group">
						...
						<div class="form-group input-group">
							...
							<p style="width:480px;" class="form-control"><?php echo date("M d, Y", strtotime($er['hire_date'])); ?></p>
						</div>
					</div>
				</div>
                <!-- /.row -->
