                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						<span class="pull-right">
							<a href="print_invoice.php" class="btn btn-success btn-sm"><i class="fa fa-print"></i> Print</a> <a href="history.php" class="btn btn-primary btn-sm"><i class="fa fa-arrow-left"></i> Back</a>
						</span>
						</h2>
                    </div>
                    <!-- /.col-lg-12 -->
