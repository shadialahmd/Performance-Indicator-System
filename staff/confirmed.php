<br>
<table width="100%" class="table table-striped table-bordered table-hover" id="ConfirmTable">
    <thead>
        <tr>
            <th>Dealer Name</th>
            <th>Total Cost</th>
    ...
    <tbody>
		<?php
			$rq=mysqli_query($con,"select * from reservation left join dealer on dealer.userid=reservation.userid where res_status='2' order by action_date desc");
