...
<!-- Edit Profile -->
	...
	<?php
		$dq=mysqli_query($con,"select * from employee left join `user` on user.userid=employee.userid where employee.userid='".$_SESSION['id']."'");
				...
				<div class="container-fluid">
                    <form role="form" method="POST" action="save_profile.php<?php echo '?id='.$_SESSION['id']; ?>" enctype="multipart/form-data">
						...
						<div class="form-group input-group">
                            ...
                            <input type="date" style="width:275px;" class="form-control" name="hire_date" value="<?php echo $drow['hire_date']; ?>">
                        </div>
						<div class="form-group input-group">
