<br>
<table width="100%" class="table table-striped table-bordered table-hover" id="ExpiredTable">
    <thead>
        <tr>
            <th>Dealer Name</th>
            <th>Total Cost</th>
    ...
    <tbody>
		<?php
			$rq=mysqli_query($con,"select * from reservation left join dealer on dealer.userid=reservation.userid where res_status='4' order by reserve_date desc");
			...
			<tr>
				...
				<td><?php echo date("M d, Y - h:i A", strtotime("+3 days", strtotime($rqrow['reserve_date']))); ?></td>
