...
<?php
	$sid=$_GET['id'];
	$sales=mysqli_query($con,"select * from sales left join dealer on dealer.userid=sales.userid where salesid='$sid'");
    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="page-header">Sales Full Details
						<span class="pull-right">
							<a onclick="window.print()" class="btn btn-success btn-sm noprint"><i class="fa fa-print"></i> Print</a> <a href="sales_report.php" class="btn btn-primary btn-sm noprint"><i class="fa fa-arrow-left"></i> Back</a>
						</span>
						</h2>
                    </div>
                    <!-- /.col-lg-12 -->
				...
				<div class="row">
					<div class="col-lg-9">
                        <p>Sold to: <?php echo $sarow['lastname']; ?>, <?php echo $sarow['firstname']; ?> <?php echo $sarow['middle_i']; ?></p>
                    </div>
					<div class="col-lg-3">
