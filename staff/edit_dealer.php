<?php
	...
	mysqli_query($con,"insert into activitylog (userid,action,activity_date) values ('".$_SESSION['id']."','Update dealer details - Firstname: ".$uqrow['firstname']."',NOW())");
	?>
		<script>
			window.alert('Dealer updated successfully!');
			window.history.back();
		</script>
	<?php
