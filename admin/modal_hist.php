<!-- History -->
    <div class="modal fade" id="full_detail<?php echo $shrow['reserveid']; ?>_<?php echo $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
				...
				<?php
					...
					$userq=mysqli_query($con,"select * from dealer where userid='$id'");
					$userow=mysqli_fetch_array($userq);
				?>
				<div class="container-fluid">
					<div class="row">
						<div class="col-lg-9 rname">
							<p>Sold to: <?php echo ucwords($userow['lastname']); ?>, <?php echo ucwords($userow['firstname']); ?> <?php echo ucwords($userow['middle_i']); ?></p>
						</div>
						<div class="col-lg-3">
					...
					<div class="row">
						<div class="col-lg-12">
							<p>Address: <?php echo ucwords($userow['address']); ?></p>
						</div>
					</div>
					<div class="row">
						<div class="col-lg-12">
							<table width="100%" class="table table-striped table-bordered table-hover">
								...
								<tbody>
									<?php
										...
										$tnbd=0;
										$tnet=0;
										$rd=mysqli_query($con,"select * from reserve_detail left join product on product.productid=reserve_detail.productid where reserveid='".$shrow['reserveid']."'");
