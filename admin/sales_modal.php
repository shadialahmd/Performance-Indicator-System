<!-- Monthly Sales Report -->
    <div class="modal fade" id="monthly" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
				...
				<div class="container-fluid">
					<form method="POST" action="view_sales.php">
						<div class="form-group input-group">
							...
							<input type="date" style="width:350px;" class="form-control" name="sales_from" required>
						</div>
						<div class="form-group input-group">
							<span class="input-group-addon" style="width:150px;">To:</span>
							<input type="date" style="width:350px;" class="form-control" name="sales_to" required>
						</div>                
				</div>
				</div>
